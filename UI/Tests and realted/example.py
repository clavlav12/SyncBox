# PyQt5 Video player
#!/usr/bin/env python
# install codec from http://codecguide.com/download_k-lite_codec_pack_full.htm
...
class VideoWindow(QMainWindow):
    ...
    def openFile(self):
        ...
        if fileName != '':
            origin = r"D:\Nvidia Record\Deceit\Deceit 2018.07.17 - 22.46.40.19.DVR.mp4"
    ...
    def handleError(self):
        self.playButton.setEnabled(False)
        print(repr(self.mediaPlayer.errorString()))
